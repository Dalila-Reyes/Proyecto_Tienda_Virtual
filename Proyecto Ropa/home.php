...
<body>
  ...
  <?php
    ...
    $sql = "SELECT * FROM banners WHERE eliminado=0   ORDER BY RAND()";
    $result = mysqli_query($conexion, $sql);

     $mostrar = mysqli_fetch_array($result)
  ?>
  <div class="center-img">
  <img src="archivos/banners/<?php echo $mostrar['id'] ?>.png" alt="Imagen" width=1000px height=250 title="<?php echo $mostrar['id'] ?>"></td>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      while($mostrar=mysqli_fetch_array($result)){
        ...
        echo '<img src="archivos/productos/' . $mostrar['id'] . '.png" alt="Imagen" width=100px height=100px title="' . $mostrar['id'] . '">';
        ...
        $buttonCount++;
        echo '<a class="btn btn-success" id="btnComprar'.$buttonCount.'" data-id="' . $mostrar['id'] . '">comprar</a>';
        echo '<br></div>';
        echo '<br></div>';
        echo '<br></div>';
...
<br>
  ...
  <script type="text/javascript">
      $(document).ready(function(){
        $("#btnComprar1").click(function(e){
          e.preventDefault();
          var idProducto = $(this).data('id');
          agregar_Carrito(idProducto);
        });

        $("#btnComprar2").click(function(e){
          e.preventDefault();
          var idProducto = $(this).data('id');
          agregar_Carrito(idProducto);
        });

        $("#btnComprar3").click(function(e){
          e.preventDefault();
          var idProducto = $(this).data('id');
          agregar_Carrito(idProducto);
        });

        $("#btnComprar4").click(function(e){
          e.preventDefault();
          var idProducto = $(this).data('id');
          agregar_Carrito(idProducto);
        });

        $("#btnComprar5").click(function(e){
          e.preventDefault();
          var idProducto = $(this).data('id');
          agregar_Carrito(idProducto);
        });

        $("#btnComprar6").click(function(e){
          e.preventDefault();
          var idProducto = $(this).data('id');
          agregar_Carrito(idProducto);
        });
