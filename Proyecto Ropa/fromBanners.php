      ...
      <div class="card">
        ...
        <form id="frm_agregar" method="post">
            ...
            <tr>
              <td>
                <div class="form-floating">
                  <input class="form-control" type="text" width="600" height="200" name="nombre" id="nombre" value="" required>
          ...
          <div class="input-field text-center"">
            ...
            <br><br><a class="btn btn-success" href="listaDeBanners.php" id="btn_new" >Regresar</a> 
          </div>
