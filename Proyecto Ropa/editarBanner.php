          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                ...
                <li class="nav-item">
                <a class="nav-link" href="fromBanners.php">Banners</a>
              </li>
              <li class="nav-item">
            ...
            <div class="col-6">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <form method="post" action="funciones/actualizarBanners.php" enctype="multipart/form-data">
                                            ...
                                            <td>
                                                <div class="form-floating">
                                                    <img class="form-floating"
                                                        src="archivos/banners/<?php echo $registro['id']; ?>.png"
                                        ...
                                        <tr>
                                         ...
                                         <td>
                                                ...
                                                <div class="form-floating">
                                                    ...
                                                    <br><br>
                                                    <a class="btn btn-success" href="listaDeBanners.php" id="btn_new" >Regresar</a>
                                                </div>
                                                    </td>
